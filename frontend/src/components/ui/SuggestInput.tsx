...
export const SuggestInput: React.FC<SuggestInputProps> = ({
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setOpen(true)
    // Nothing is highlighted until an arrow key picks a suggestion, so Enter keeps what was
    // typed instead of swapping in the first match ("Spring" becoming "Springfield").
    setHighlightIndex(-1)
  }
